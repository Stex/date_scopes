  ...
  module ActiveRecord
    ...
    module ClassMethods
      ...
      def simple_date_scopes_on(field, options = {})
        ...
        named_scope acts_as_date_scope_name(field, :yesterday, prefix),   lambda { in_x_of(table_name, Date.today - 1.day, field, :day, options) }
        named_scope acts_as_date_scope_name(field, :today, prefix),       lambda { in_x_of(table_name, Date.today, field, :day, options) }
        named_scope acts_as_date_scope_name(field, :tomorrow, prefix),    lambda { in_x_of(table_name, Date.today + 1.day, field, :day, options) }

        named_scope acts_as_date_scope_name(field, :in_week_of, prefix),  lambda {|date| in_x_of(table_name, date, field, :week, options) }
        named_scope acts_as_date_scope_name(field, :last_week, prefix),   lambda { in_x_of(table_name, Date.today - 7.days, field, :week, options) }
        named_scope acts_as_date_scope_name(field, :this_week, prefix),   lambda { in_x_of(table_name, Date.today, field, :week, options) }
        named_scope acts_as_date_scope_name(field, :next_week, prefix),   lambda { in_x_of(table_name, Date.today + 7.days, field, :week, options) }

        named_scope acts_as_date_scope_name(field, :in_month_of, prefix), lambda {|date| in_x_of(table_name, date, field, :month, options) }
        named_scope acts_as_date_scope_name(field, :last_month, prefix),  lambda { in_x_of(table_name, Date.today - 1.months, field, :month, options) }
        named_scope acts_as_date_scope_name(field, :this_month, prefix),  lambda { in_x_of(table_name, Date.today, field, :month, options) }
        named_scope acts_as_date_scope_name(field, :next_month, prefix),  lambda { in_x_of(table_name, Date.today + 1.months, field, :month, options) }

        named_scope acts_as_date_scope_name(field, :in_year_of, prefix),  lambda {|date| in_x_of(table_name, date, field, :year, options) }
        named_scope acts_as_date_scope_name(field, :last_year, prefix),   lambda { in_x_of(table_name, Date.today - 1.years, field, :year, options) }
        named_scope acts_as_date_scope_name(field, :this_year, prefix),   lambda { in_x_of(table_name, Date.today, field, :year, options) }
        named_scope acts_as_date_scope_name(field, :next_year, prefix),   lambda { in_x_of(table_name, Date.today + 1.years, field, :year, options) }
